...
variable "db2_log_archive_disk_size" {
  type        = number
  description = "The size of the db2 log archive disk in GB."
  default     = 10
}

variable "db2_dump_disk_size" {
  type        = number
  description = "The size of the db2 dump disk in GB."
  default     = 10
}

variable "db2_log_dir_disk_size" {
  type        = number
  description = "The size of the db2 log dir disk in GB."
  default     = 10
}
...
variable "db2_sid_disk_type" {
  type        = string
  description = "The type of the db2 sid disk."
  default     = "pd-ssd"
}
...
variable "db2_dump_disk_type" {
  type        = string
  description = "The type of the db2 dump disk."
  default     = "pd-ssd"
}

variable "db2_log_dir_disk_type" {
  type        = string
  description = "The type of the db2 log dir disk."
  default     = "pd-ssd"
}
